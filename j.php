            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.success) {
                        ...
                        // Assuming response is a single object with bazaar_id and bazaar_name
                        dropdown.append($("<option>").val(response.bazaar_id).text(response.bazaar_name));

                        console.log("Dropdown populated with options:", response.bazaar_name);
                    } else {
