                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        <div class="card">
                                            ...
                                            <form class="update-form">
                                                ...
                                                <input type="text" name="bazaar_opentime" placeholder="Open Time"
                                                    value="<?php echo $row['bazaar_opentime']; ?>">
                                                <input type="text" name="bazaar_closetime" placeholder="Close Time"
                                                    value="<?php echo $row['bazaar_closetime']; ?>">
                                                <input type="text" name="bazaar_result" placeholder="Result"
                                                    value="<?php echo $row['bazaar_result']; ?>">
                        ...
                        <div class="tab-pane active" id="settings-tab" role="tabpanel">
                            ...
                            <div class="p-3">
                                ...
                                <div class="form-check form-switch mb-3">
                                    <input type="checkbox" class="form-check-input" name="leftbar-color"
                                ...
                                <div class="form-check form-switch mb-1">
                                    <input type="checkbox" class="form-check-input" name="leftbar-size"
