...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Hazar Line | Adminto - Responsive Admin Dashboard Template</title>
        ...
        <div id="wrapper">
            ...
            <div class="navbar-custom">
                    ...
                    <ul class="list-unstyled topnav-menu topnav-menu-left mb-0">
                        ...
                        <li>
                            <h4 class="page-title-main">Hazar Line</h4>
                        </li>
            ...
            <div class="content-page">
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6">
                                <script>document.write(new Date().getFullYear())</script> &copy; SattaMatka By <a href="">Uss</a> 
                            </div>
                            <div class="col-md-6">
